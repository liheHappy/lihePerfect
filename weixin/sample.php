...
<body>
  	...
  	<button id="localtion">获取地理位置</button>
</body>
...
<script>
  ...
  wx.ready(function () {
    ...
    //获取地理位置：
    var localtion=document.getElementById("localtion");
    localtion.addEventListener("touchstart",function(){
    		wx.getLocation({
		    ...
		    success: function (res) {
		        ...
		        wx.openLocation({
						    ...
						    name: '小仙女的妙凯凯', // 位置名
						    address: '这是妙凯凯经常斗图并装逼的地方', // 地址详情说明
